...
from tests.fixtures.test_classes import SimpleService, DatabaseService, UserService
...
class TestMirrorCustomization(unittest.TestCase):
    ...
    def test_custom_placeholder_and_parser_together(self):
        ...
        mirror = Mirror(
            'tests.fixtures',
            parser=CustomReferenceParser(),
            placeholder="$create"
        )
        
        config_data = {
            "service": {
                "$create": "simple_service@my_instance",
                "name": "combined_test"
            },
            "reference_test": {
                "value": "$my_instance"  # This should resolve to the instance
            }
        }
    ...
    def test_parser_validation_error(self):
        ...
        config_data = {
            "service": {
                "$mirror": "simple_service",  # Missing version
                "name": "invalid"
            }
        }
